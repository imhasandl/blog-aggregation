...
type CreateFeedFollowRaw struct {
	ID uuid.UUID
	CreatedAt time.Time
	UpdatedAt time.Time
	UserID uuid.UUID
...
func (q *Queries) CreateFeedFollow(ctx context.Context, arg CreateFeedFollowParams) (CreateFeedFollowRaw, error) {
